    ...
    export default {
        ...
        created() {
            ...
            this._data.tab = [{
                ...
                token: 'insert',
                exec: () => {
                    vueJSQL.jsql.insert('insert into person (name) values ("Zbyszek")')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
                ...
                token: 'delete',
                exec: () => {
                    vueJSQL.jsql.delete('delete from person where age = 30')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
                ...
                token: 'delete',
                exec: () => {
                    vueJSQL.jsql.delete('delete from trees where hight = 10')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
                ...
                token: 'select',
                exec: () => {
                    vueJSQL.jsql.select('select * from person')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
                ...
                token: 'update',
                exec: () => {
                    vueJSQL.jsql.update('update person set age = 40 where age > :age')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
                ...
                token: 'update',
                exec: () => {
                    vueJSQL.jsql.update('update person set age = 40h')
                        .then((res) => {
                            console.log(res);
                        }).catch((e) => {
                        console.log(e);
